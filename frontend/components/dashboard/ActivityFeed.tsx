...
const MOCK_ACTIVITIES: ActivityItem[] = [
  {
    ...
    title: '47 new opportunities discovered',
    subtitle: 'LinkedIn, Indeed, Naukri',
  ...
  },
  {
    id: '2',
    type: 'high_match',
    title: '3 high-match jobs found (>85%)',
  ...
  },
  {
    ...
    subtitle: '12 curated opportunities',
    timestamp: new Date(Date.now() - 3 * 60 * 60 * 1000).toISOString(),
  },
  {
    id: '4',
    type: 'recruiter_found',
    title: '5 new recruiters identified',
    subtitle: 'From job postings',
  ...
  },
  {
    id: '5',
    type: 'new_jobs',
    title: '28 jobs from LinkedIn',
    subtitle: 'Strategy & Management Consulting',
  ...
  },
  {
    ...
    subtitle: 'BCG interview scheduled',
